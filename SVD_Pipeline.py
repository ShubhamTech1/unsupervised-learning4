...
# **Import the data**
University = pd.read_excel(r"D:/DATA SCIENTIST/DATA SCIENCE/STUDY MATERIAL/dimensionality reduction/SVD_code/University_Clustering.xlsx")
University
...
# Define SVD model in standard format with missing value imputation using mean strategy.
...
# then check how many svd we want to extract which will give me more information means feature extraction:
...
newdf = pd.read_excel(r"D:\DATA SCIENTIST\DATA SCIENCE\STUDY MATERIAL\dimensionality reduction\SVD_code\new_Univ_4_pred.xlsx") 
newdf
